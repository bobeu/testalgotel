...
def buy_token(update, context):
    ...
    amount_to_pay = int(current_price * qty)
    alc_bal = algod_client.account_info(buyer)['amount']

    assert alc_bal > amount_to_pay, response_end(update, context, "Not enough balance.")
